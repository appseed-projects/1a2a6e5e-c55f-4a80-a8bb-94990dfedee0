...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-11 17:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1a2a6e5e-c55f-4a80-a8bb-94990dfedee0.git
$ cd 1a2a6e5e-c55f-4a80-a8bb-94990dfedee0
```
